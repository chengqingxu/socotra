      ...
      <div class="row">
        <div class="col-sm-6">
          <div class="card" style="width: 22rem;">
            <img class="card-img-top" src="images\blue.jpg" alt="Card image cap">
            <div class="card-body">
              <h5 class="card-title">Chengqing Xu</h5>
            </div>
          </div>
        </div>
        <div class="col-sm-6">
          <div class="card" style="width: 22rem;">
            <img class="card-img-top" src="images\blue.jpg" alt="Card image cap">
            <div class="card-body">
              <h5 class="card-title">Matthew Milholm</h5>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-sm-6">
          <div class="card" style="width: 22rem;">
            <img class="card-img-top" src="images\blue.jpg" alt="Card image cap">
            <div class="card-body">
              <h5 class="card-title">Manny Pasquale</h5>
            </div>
          </div>
        </div>
        <div class="col-sm-6">
          <div class="card" style="width: 22rem;">
            <img class="card-img-top" src="images\blue.jpg" alt="Card image cap">
            <div class="card-body">
              <h5 class="card-title">Eric Kimball</h5>
            </div>
          </div>
        </div>
      </div>
